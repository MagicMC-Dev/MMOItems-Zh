...
public class ItemStats {
    ...
    DISABLE_INTERACTION = new DisableStat("INTERACTION", VersionMaterial.GRASS_BLOCK.toMaterial(), "禁用交互", new String[]{"!block", "all"}, "禁止任何不必要的交互:", "方块放置、物品使用..."),
            DISABLE_CRAFTING = new DisableStat("CRAFTING", VersionMaterial.CRAFTING_TABLE.toMaterial(), "禁用合成", "在合成时玩家无法使用此物品。"), DISABLE_SMELTING = new DisableStat("SMELTING", Material.FURNACE, "禁用熔炼", "在熔炼炉中玩家无法使用此物品。"),
            DISABLE_SMITHING = new DisableStat("SMITHING", Material.DAMAGED_ANVIL, "禁用锻造", "在锻造台中玩家无法锻造此物品。"),
            ...
            DISABLE_REPAIRING = new DisableStat("REPAIRING", Material.ANVIL, "禁用修复", new String[]{"!block", "all"}, "在铁砧中玩家无法使用此物品进行修复。"),
    ...
    REQUIRED_LEVEL = new RequiredLevel(),
            ...
            CRITICAL_STRIKE_CHANCE = new DoubleStat("CRITICAL_STRIKE_CHANCE", Material.NETHER_STAR, "暴击概率", new String[]{"暴击造成更多伤害。", "以%的几率触发。"}, new String[]{"!miscellaneous", "!block", "all"}),
            CRITICAL_STRIKE_POWER = new DoubleStat("CRITICAL_STRIKE_POWER", Material.NETHER_STAR, "暴击威力", new String[]{"武器暴击额外造成的伤害。", "(与默认值叠加)", "以%计算。"}, new String[]{"!miscellaneous", "!block", "all"}),
            SKILL_CRITICAL_STRIKE_CHANCE = new DoubleStat("SKILL_CRITICAL_STRIKE_CHANCE", Material.NETHER_STAR, "技能暴击概率", new String[]{"增加技能暴击的触发几率（以%计算）。"}, new String[]{"!miscellaneous", "!block", "all"}),
            SKILL_CRITICAL_STRIKE_POWER = new DoubleStat("SKILL_CRITICAL_STRIKE_POWER", Material.NETHER_STAR, "技能暴击威力", new String[]{"技能暴击造成的额外伤害（以%计算）。", "(与默认值叠加)", "以%计算。"}, new String[]{"!miscellaneous", "!block", "all"}),
            BLOCK_POWER = new DoubleStat("BLOCK_POWER", Material.IRON_HELMET, "格挡威力", new String[]{"你的护甲/盾牌能够格挡的伤害百分比。", "默认：25%"}, new String[]{"!miscellaneous", "!block", "all"}),
            ...
            BLUNT_POWER = new DoubleStat("BLUNT_POWER", Material.IRON_AXE, "钝击力量", new String[]{"范围攻击的半径。", "若设置为2.0，目标周围2格内的敌人将受到伤害。"}, new String[]{"blunt", "gem_stone"}),
            BLUNT_RATING = new DoubleStat("BLUNT_RATING", Material.BRICK, "钝击评分", new String[]{"钝击攻击的力量。", "若设置为50%，受到攻击的敌人", "将受到初始伤害的50%。"}, new String[]{"blunt", "gem_stone"}),
            WEAPON_DAMAGE = new DoubleStat("WEAPON_DAMAGE", Material.IRON_SWORD, "武器伤害", new String[]{"额外的击中武器伤害（以%计算）。"}),
            SKILL_DAMAGE = new DoubleStat("SKILL_DAMAGE", Material.BOOK, "技能伤害", new String[]{"额外的技能伤害（以%计算）。"}),
            PROJECTILE_DAMAGE = new DoubleStat("PROJECTILE_DAMAGE", Material.ARROW, "弹道伤害", new String[]{"额外的技能/武器弹道伤害。"}),
            MAGIC_DAMAGE = new DoubleStat("MAGIC_DAMAGE", Material.MAGMA_CREAM, "魔法伤害", new String[]{"额外的魔法技能伤害（以%计算）。"}),
            ...
            DAMAGE_REDUCTION = new DoubleStat("DAMAGE_REDUCTION", Material.IRON_CHESTPLATE, "伤害减免", new String[]{"减少来自任何来源的伤害。", "以%计算。"}),
            FALL_DAMAGE_REDUCTION = new DoubleStat("FALL_DAMAGE_REDUCTION", Material.FEATHER, "坠落伤害减免", new String[]{"减少坠落伤害。", "以%计算。"}),
            PROJECTILE_DAMAGE_REDUCTION = new DoubleStat("PROJECTILE_DAMAGE_REDUCTION", VersionMaterial.SNOWBALL.toMaterial(), "弹道伤害减免", new String[]{"减少弹道伤害。", "以%计算。"}),
            PHYSICAL_DAMAGE_REDUCTION = new DoubleStat("PHYSICAL_DAMAGE_REDUCTION", Material.LEATHER_CHESTPLATE, "物理伤害减免", new String[]{"减少物理伤害。", "以%计算。"}),
            FIRE_DAMAGE_REDUCTION = new DoubleStat("FIRE_DAMAGE_REDUCTION", Material.BLAZE_POWDER, "火焰伤害减免", new String[]{"减少火焰伤害。", "以%计算。"}),
            MAGIC_DAMAGE_REDUCTION = new DoubleStat("MAGIC_DAMAGE_REDUCTION", Material.POTION, "魔法伤害减免", new String[]{"减少药水造成的魔法伤害。", "以%计算。"}),
            PVE_DAMAGE_REDUCTION = new DoubleStat("PVE_DAMAGE_REDUCTION", VersionMaterial.PORKCHOP.toMaterial(), "PvE 伤害减免", new String[]{"减少怪物造成的伤害。", "以%计算。"}),
            PVP_DAMAGE_REDUCTION = new DoubleStat("PVP_DAMAGE_REDUCTION", VersionMaterial.SKELETON_SKULL.toMaterial(), "PvP 伤害减免", new String[]{"减少玩家造成的伤害。", "以%计算。"}),
            UNDEAD_DAMAGE = new DoubleStat("UNDEAD_DAMAGE", VersionMaterial.SKELETON_SKULL.toMaterial(), "不死生物伤害", new String[]{"对不死生物造成额外伤害。", "以%计算。"}),
    ...
    ABILITIES = new Abilities(),
            ...
            DOWNGRADE_ON_DEATH_CHANCE = new DoubleStat("DEATH_DOWNGRADE_CHANCE", Material.SKELETON_SKULL, "死亡降级几率", new String[]{"物品在玩家死亡时降级的概率。", "", "超过100%将确保降级一件物品，", "并再次投掷以降级另一件（使用多余的概率）。", "&6相同的物品不会降级两次。"}, new String[]{"!miscellaneous", "!block", "all"}, false),
