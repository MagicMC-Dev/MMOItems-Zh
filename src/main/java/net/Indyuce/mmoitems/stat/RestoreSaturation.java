...
public class RestoreSaturation extends DoubleStat implements SelfConsumable {
    public RestoreSaturation() { super("RESTORE_SATURATION", Material.GOLDEN_CARROT, "Saturation Restoration", new String[]{"Saturation given when consumed."}, new String[]{"consumable"}); }
    ...
    public boolean onSelfConsume(@NotNull VolatileMMOItem mmo, @NotNull Player player) {
        ...
        if (saturation != 0) { MMOUtils.saturate(player, saturation); return true; }
