...
// 角色扩展属性
    REQUIRED_LEVEL = new RequiredLevel(), // 所需等级
             ...
             BLOCK_POWER = new DoubleStat("BLOCK_POWER", Material.IRON_HELMET, "格挡强度", new String[]{"你的护甲/盾牌阻挡伤害的百分比默认值: 25%"}, new String[]{"!miscellaneous", "!block", "all"}),
             ...
             DODGE_RATING = new DoubleStat("DODGE_RATING", Material.FEATHER, "闪避几率", new String[]{"闪避攻击的几率完全闪避将无视攻击伤害"}, new String[]{"!miscellaneous", "!block", "all"}),
             ...
             PARRY_RATING = new DoubleStat("PARRY_RATING", Material.BUCKET, "招架几率", new String[]{"招架攻击的几率招架将无视攻击伤害并击退攻击者"}, new String[]{"!miscellaneous", "!block", "all"}),
             ...
             ARROW_VELOCITY = new DoubleStat("ARROW_VELOCITY", Material.ARROW, "箭矢速度", new String[]{"决定你的武器能射出多远默认值: 1.0"}, new String[]{"gem_stone", "bow", "crossbow"}),
             ...
             BLUNT_POWER = new DoubleStat("BLUNT_POWER", Material.IRON_AXE, "钝击强度", new String[]{"范围攻击的半径若设置为2.0, 则目标周围2格的敌人将受到伤害"}, new String[]{"blunt", "gem_stone"}),
             BLUNT_RATING = new DoubleStat("BLUNT_RATING", Material.BRICK, "钝击等级", new String[]{"钝击攻击的威力若设置为50%, 被该攻击击中的敌人将承受初始伤害的50%"}, new String[]{"blunt", "gem_stone"}),
             ...
             DEFENSE = new DoubleStat("DEFENSE", Material.SHIELD, "防御", new String[]{"减少来自任何来源的伤害公式可在MMOLib配置中设置"}),
             DAMAGE_REDUCTION = new DoubleStat("DAMAGE_REDUCTION", Material.IRON_CHESTPLATE, "伤害减免", new String[]{"减少来自任何来源的伤害以百分比表示"}),
             FALL_DAMAGE_REDUCTION = new DoubleStat("FALL_DAMAGE_REDUCTION", Material.FEATHER, "坠落伤害减免", new String[]{"减少坠落伤害以百分比表示"}),
             PROJECTILE_DAMAGE_REDUCTION = new DoubleStat("PROJECTILE_DAMAGE_REDUCTION", VersionMaterial.SNOWBALL.toMaterial(), "抛射物伤害减免", new String[]{"减少抛射物伤害以百分比表示"}),
             PHYSICAL_DAMAGE_REDUCTION = new DoubleStat("PHYSICAL_DAMAGE_REDUCTION", Material.LEATHER_CHESTPLATE, "物理伤害减免", new String[]{"减少物理伤害以百分比表示"}),
             FIRE_DAMAGE_REDUCTION = new DoubleStat("FIRE_DAMAGE_REDUCTION", Material.BLAZE_POWDER, "火焰伤害减免", new String[]{"减少火焰伤害以百分比表示"}),
             MAGIC_DAMAGE_REDUCTION = new DoubleStat("MAGIC_DAMAGE_REDUCTION", Material.POTION, "魔法伤害减免", new String[]{"减少由药水造成的魔法伤害以百分比表示"}),
             PVE_DAMAGE_REDUCTION = new DoubleStat("PVE_DAMAGE_REDUCTION", VersionMaterial.PORKCHOP.toMaterial(), "PvE伤害减免", new String[]{"减少来自怪物的伤害以百分比表示"}),
             PVP_DAMAGE_REDUCTION = new DoubleStat("PVP_DAMAGE_REDUCTION", VersionMaterial.SKELETON_SKULL.toMaterial(), "PvP伤害减免", new String[]{"减少来自玩家的伤害以百分比表示"}),
             UNDEAD_DAMAGE = new DoubleStat("UNDEAD_DAMAGE", VersionMaterial.SKELETON_SKULL.toMaterial(), "不死族伤害", new String[]{"对不死族造成额外伤害以百分比表示"}),
